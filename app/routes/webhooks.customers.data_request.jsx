...
export async function action({ request }) {
  ...
  // No customer or order records are persisted by this app. Do not log the
  // request payload because it can contain customer personal information.
  console.log("[WEBHOOK customers/data_request]", { shop, topic });
  return new Response("ok", { status: 200, headers: { "Content-Type": "text/plain" } });
}
